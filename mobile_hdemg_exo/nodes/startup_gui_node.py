...
class GUIApp:
    ...
    def create_widgets(self):
        ...
        exo_label = ttk.Label(self.root, text="Exo Connection:")
        exo_label.grid(row=3, column=0, padx=10, pady=5, sticky="w")
        exo_choices = ["True", "False"]
        self.exo_dropdown = ttk.Combobox(
            self.root, values=exo_choices, textvariable=self.exo_var)
        self.exo_dropdown.grid(row=3, column=1, padx=10, pady=5, sticky="w")
        ...
        muscles_label.grid(row=5, column=0, padx=10, pady=5, sticky="w")
    ...
    def start_process(self):
        ...
        rospy.set_param("/exo_connected", selected_exo)
        ...
        print("Exo Connection:", selected_exo)
