...
class GUIApp:
    ...
    def create_widgets(self):
        ...
        self.muscles_dropdown.grid(row=4, column=1, padx=10, pady=5, sticky="w")
    ...
    def start_process(self):
        ...
        selected_analyzer = bool(self.analyzer_var.get())
